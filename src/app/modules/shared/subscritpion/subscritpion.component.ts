...
import { VideoPlayLinkREQUEStBODyPOST, UserAccountDetailREQUEStBODyPOST } from 'src/app/model/account/api/user-account-detail-request-body-post';
      ...
      this.loginService.getCheckNumberAvail(data).subscribe((data:any)=>{
        if(data){
          ...
          if(this.numberStatus){
            ...
            setTimeout(() => { this.loginService.ghanaSubscribe(phonenumber,this.selectedPack).subscribe((data: any) => {
